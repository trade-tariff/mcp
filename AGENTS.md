...
The application is an MCP (Model Context Protocol) server that exposes UK Trade Tariff commodity lookup as tools for AI clients. It wraps the GOV.UK Online Trade Tariff backend API and implements MCP 2025-11-25 (streamable HTTP transport).
