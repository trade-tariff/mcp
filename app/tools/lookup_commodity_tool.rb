  ...
  def self.build_full_params
    {
      ...
      "fields[measure]" => "effective_start_date,effective_end_date,excise,vat,reduction_indicator,measure_type,duty_expression,geographical_area,measure_conditions,order_number,footnotes,additional_code",
      "fields[measure_type]" => "description",
      "fields[duty_expression]" => "base",
      "fields[geographical_area]" => "id,description,geographical_area_id",
      "fields[measure_condition]" => "condition,document_code,certificate_description,requirement,action,duty_expression",
      "fields[additional_code]" => "code,description",
